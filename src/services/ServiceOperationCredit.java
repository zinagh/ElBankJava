     ...
     public List<OperationCredit> getAll() {
       ...
       try {
            ...
            while(rs.next()){
                ...
                p.setDateOp(rs.getDate(3));
                
                p.setMontPayer( rs.getInt(4));
                p.setEcheance( rs.getDate(5));
                p.setTauxInteret( rs.getInt(6));
                p.setSolvabilite( rs.getInt(7));
                
                p.setTypeOperation( rs.getString(8));
                p.setCreditid(rs.getInt(2));
